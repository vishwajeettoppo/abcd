    ...
    >
      <div className="p-4">
        <div className="flex items-start justify-between">
          ...
          <motion.button
            className={`p-2 rounded-full cursor-pointer ${isPinned
      ...
      <div className="cursor-pointer flex items-center justify-between mt-4">
        ...
        >
          <motion.button
            className="cursor-pointer p-2 rounded-full hover:bg-purple-50 text-gray-600 hover:text-purple-600 transition-colors"
            onClick={onEdit}
            variants={buttonVariants}
            whileHover="hover"
          >
