...
const Navbar = ({ userInfo, onSearchNote, handleClearSearch }) => {
  ...
  return (
    <div className="bg-linear-to-r from-[#f2dcfc] via-[#FFFFFF] to-[#f1dcfc] px-4 sm:px-6 py-3 shadow-md border-b border-[#16A34A]/30">
      <div className="hidden sm:flex sm: flex-row sm: items-center sm: justify-between sm:gap-0">
        <div className="flex items-center">
          <h2 className="text-2xl font-extrabold tracking-tight drop-shadow-sm text-[#1E293B]">
            <span className="inline-block text-[#6b16a3] hover: scale-105 transition-transform duration-300">
              Byte
            </span>
            <span className="inline-block text-[#b40984]">Note</span>
          </h2>
        </div>
      ...
      <div className="sm:hidden">
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-extrabold tracking-tight text-[#7616a3] drop-shadow-sm">
            <span className="text-[#6f16a3]">Byte</span>
